-- Schema definitions for TRPG tables
...
CREATE TABLE IF NOT EXISTS player_warship (
    ...
    PRIMARY KEY (player_id, warship_id)
);
...
CREATE TABLE IF NOT EXISTS warship_weapon (
    ...
    PRIMARY KEY (warship_id, weapon_id)
);

CREATE TABLE IF NOT EXISTS warship_expendable (
    warship_id VARCHAR(64) NOT NULL,
    expendable_type_id BIGINT NOT NULL,
    expendable_num INT NOT NULL,
    PRIMARY KEY (warship_id, expendable_type_id)
);

CREATE TABLE IF NOT EXISTS warship_skill (
    warship_id VARCHAR(64) NOT NULL,
    skill_id BIGINT NOT NULL,
    PRIMARY KEY (warship_id, skill_id)
);
...
CREATE TABLE IF NOT EXISTS mobility_type (
    level INT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS concealment_type (
    level INT PRIMARY KEY,
