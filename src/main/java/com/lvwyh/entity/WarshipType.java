...
public class WarshipType {
    ...
    public String getWarshipTypeId() { return warshipTypeId; }
    public void setWarshipTypeId(String warshipTypeId) { this.warshipTypeId = warshipTypeId; }
