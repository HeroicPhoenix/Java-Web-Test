...
public class NamingAdaptationController {
    ...
    private final NamingAdaptationService namingAdaptationService;

    public NamingAdaptationController(NamingAdaptationService namingAdaptationService) {
        this.namingAdaptationService = namingAdaptationService;
    }
